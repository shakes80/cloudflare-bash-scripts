...
# add dkim to domain on mail/Zimbra
ssh zero-mail-dmz 'sudo su - zimbra -c "/opt/zimbra/libexec/zmdkimkeyutil -a -d '$DOMAINNAME'"' > ./data/$DOMAINNAME.dkim.public
# query dkim for domain on mail/Zimbra
ssh zero-mail-dmz 'sudo su - zimbra -c "/opt/zimbra/libexec/zmdkimkeyutil -q -d '$DOMAINNAME'"' > ./data/$DOMAINNAME.dkim.query

# remove dkim to domain on mail/Zimbra
# ssh zero-mail-dmz 'sudo su - zextras -c "/opt/zextras/libexec/zmdkimkeyutil -r -d '$DOMAINNAME'"' > ./data/$DOMAINNAME.dkim.public
